...
const options = {
  ...
  minDate: new Date("2023-06-12"),
  theme: {
    background: "bg-white shadow-xl border",
    todayBtn: "bg-primary hover:bg-primary hover:opacity-80",
    clearBtn: "",
    icons: "",
    text: "",
    disabledText: "text-black/20 hover:bg-transparent cursor-default",
    input: "grow focus:outline-primary",
    inputIcon: "",
  ...
  datepickerClassNames: "top-9",
  defaultDate: new Date("2023-06-13"),
  language: "en",
};
export default function _DatePicker() {
  ...
  return (
    <>
            ...
            <div className="grid flex-grow w-full h-auto grid-cols-7 grid-rows-5 gap-px pt-px mt-1 bg-gray-200">
              ...
              <div className="group relative flex flex-col bg-white">
                ...
                <div className="flex flex-col px-1 py-1 overflow-auto">
                  <button className="hover:bg-gray-200 flex items-center flex-shrink-0 h-5 px-1 text-xs">
                ...
                <button className="group-hover:flex hover:bg-gray-500 absolute bottom-0 right-0 flex items-center justify-center hidden w-6 h-6 mb-2 mr-2 text-white bg-gray-400 rounded">
                  <svg
                    viewBox="0 0 20 20"
                    fill="currentColor"
      ...
      <a
        className="hover:bg-blue-600 fixed bottom-0 right-0 flex items-center justify-center h-8 pl-1 pr-2 mb-4 mr-4 text-blue-100 bg-blue-600 rounded-full shadow-lg"
        href="https://twitter.com/lofiui"
        target="_top">
        <div className="flex items-center justify-center w-6 h-6 bg-blue-500 rounded-full">
          <svg
            viewBox="0 0 24 24"
            className="r-jwli3a r-4qtqp9 r-yyyyoo r-16y2uox r-1q142lx r-8kz0gk r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-1srniue w-4 h-4 fill-current">
            <g>
